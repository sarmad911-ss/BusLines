...
try {
  ...
  window.trumbowyg = __webpack_require__(/*! trumbowyg */ "./node_modules/trumbowyg/dist/trumbowyg.js");
  window.datepicker = __webpack_require__(/*! tiny-date-picker */ "./node_modules/tiny-date-picker/dist/tiny-date-picker.js");
  window.daterangepicker = __webpack_require__(/*! tiny-date-picker/dist/date-range-picker */ "./node_modules/tiny-date-picker/dist/date-range-picker.js");

  __webpack_require__(/*! ./components/customSelect */ "./resources/assets/js/components/customSelect.js");

  __webpack_require__(/*! ./components/axios.js */ "./resources/assets/js/components/axios.js");
...
$(document).ready(function () {
  $(document).on('click', '.date-picker-input', function () {
    var dp = datepicker(this, {
      ...
      mode: 'dp-modal',
      //dp-modal dp-below dp-pernament
  ...
  $('.customEditor').trumbowyg({
    ...
    ['formatting'], ['strong', 'em', 'del'], ['link'], ['insertImage', 'upload'], ['justifyLeft', 'justifyCenter', 'justifyRight', 'justifyFull'], ['unorderedList', 'orderedList'], ['horizontalRule'], ['removeformat']],
  ...
  $.fn.customSelect = function (options) {
    ...
    function init(object) {
      ...
      */
      ...
      typeof _this.attr('autocomplete') !== 'undefined' ? customSelectParent.append('<input class="customSelect__current-value" placeholder="Search..." value="' + customSelectSelectedLabel + '">') : customSelectParent.append('<span class="customSelect__current-value">' + customSelectSelectedLabel + '</span>');
      ...
      selectItems.each(function (index, option) {
        ...
        customSelectValueList.append('<div class="customSelect-value ' + autoCompleteClass + activeState + '" select-item="' + index + '" style="width:' + customSelectItemWidth + '%">' + $(option).text() + '</div>');
      });
    ...
    */
    ...
    function bindCurrentValueClick(object) {
      $(object).closest('.customSelect-container').find('.customSelect__current-value').bind('click', function () {
        ...
        if (!$(this).closest('.customSelect-object').hasClass("disabled")) if (opened) $(this).closest('.customSelect-object').removeClass('opened');else $(this).closest(".customSelect-object").addClass("opened");
    ...
    function bindSelectValuesListValueClick(object) {
      $(object).closest('.customSelect-container').find('.customSelect-value ').bind('click', function () {
        ...
        if (customSelectObj.attr('select-multiple')) {} else {
          ...
          if (typeof initialSelect.attr('autocomplete') == 'undefined') {
            customSelectObj.find('.customSelect__current-value').text($(this).text());
          } else {
            customSelectObj.find('.customSelect__current-value').val($(this).text());
          }
    ...
    function bindClearValueButton(object) {
      $(object).closest('.customSelect-container').find('.customSelect-icon.clear-icon').bind('click', function () {
        ...
        var initialSelect = selectParent.find('select');
        customSelectObj.find('.customSelect-value').removeClass('active');
        typeof initialSelect.attr('autocomplete') == 'undefined' ? customSelectObj.find('.customSelect__current-value').text('Choose value') : customSelectObj.find('.customSelect__current-value').val('Choose value');
        $(initialSelect.find('option')).prop('selected', false);
      });
    }
      ...
      $(object).closest('.customSelect-container').find('.customSelect__current-value').bind('keyup', function () {
        ...
        $(customSelectValueList).each(function (index, item) {
          ...
          if (matchStartIndex >= 0) {
            var matchedString = $(item).text().slice(matchStartIndex, matchStartIndex + (parseInt(autocompleteInputValue.toLowerCase().length = 1) ? parseInt(autocompleteInputValue.toLowerCase().length) : 1));
            var newString = $(item).text().slice(0, matchStartIndex) + '<strong>' + matchedString + '</strong>' + $(item).text().substr(matchStartIndex + parseInt(autocompleteInputValue.toLowerCase().length), $(item).text().length - parseInt(autocompleteInputValue.toLowerCase().length) - matchStartIndex);
...
/***/ "./resources/assets/sass/userModule/auth.scss":
/*!****************************************************!*\
  !*** ./resources/assets/sass/userModule/auth.scss ***!
  \****************************************************/
/*! no static exports found */
...
/***/ "./resources/assets/sass/userModule/busProfile.scss":
/*!**********************************************************!*\
  !*** ./resources/assets/sass/userModule/busProfile.scss ***!
  \**********************************************************/
/*! no static exports found */
...
/***/ "./resources/assets/sass/userModule/buslist.scss":
/*!*******************************************************!*\
  !*** ./resources/assets/sass/userModule/buslist.scss ***!
  \*******************************************************/
/*! no static exports found */
...
/***/ "./resources/assets/sass/userModule/finances.scss":
/*!********************************************************!*\
  !*** ./resources/assets/sass/userModule/finances.scss ***!
  \********************************************************/
/*! no static exports found */
...
/***/ "./resources/assets/sass/userModule/settings.scss":
/*!********************************************************!*\
  !*** ./resources/assets/sass/userModule/settings.scss ***!
  \********************************************************/
/*! no static exports found */
...
/***/ "./resources/assets/sass/userModule/tripProfile.scss":
/*!***********************************************************!*\
  !*** ./resources/assets/sass/userModule/tripProfile.scss ***!
  \***********************************************************/
/*! no static exports found */
...
/***/ "./resources/assets/sass/userModule/tripStore.scss":
/*!*********************************************************!*\
  !*** ./resources/assets/sass/userModule/tripStore.scss ***!
  \*********************************************************/
/*! no static exports found */
...
/***/ "./resources/assets/sass/userModule/tripsList.scss":
/*!*********************************************************!*\
  !*** ./resources/assets/sass/userModule/tripsList.scss ***!
  \*********************************************************/
/*! no static exports found */
...
/***/ "./resources/assets/sass/userModule/userProfile.scss":
/*!***********************************************************!*\
  !*** ./resources/assets/sass/userModule/userProfile.scss ***!
  \***********************************************************/
/*! no static exports found */
...
/***/ "./resources/assets/sass/userModule/userslist.scss":
/*!*********************************************************!*\
  !*** ./resources/assets/sass/userModule/userslist.scss ***!
  \*********************************************************/
/*! no static exports found */
...
/***/ 0:
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** multi ./resources/assets/js/app.js ./resources/assets/sass/app.scss ./resources/assets/sass/userModule/auth.scss ./resources/assets/sass/userModule/userslist.scss ./resources/assets/sass/userModule/userProfile.scss ./resources/assets/sass/userModule/settings.scss ./resources/assets/sass/userModule/buslist.scss ./resources/assets/sass/userModule/busProfile.scss ./resources/assets/sass/userModule/finances.scss ./resources/assets/sass/userModule/tripsList.scss ./resources/assets/sass/userModule/tripStore.scss ./resources/assets/sass/userModule/tripProfile.scss ./resources/assets/sass/loader.scss ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! C:\OSPanel\domains\bus-lines.lk\resources\assets\js\app.js */"./resources/assets/js/app.js");
__webpack_require__(/*! C:\OSPanel\domains\bus-lines.lk\resources\assets\sass\app.scss */"./resources/assets/sass/app.scss");
__webpack_require__(/*! C:\OSPanel\domains\bus-lines.lk\resources\assets\sass\userModule\auth.scss */"./resources/assets/sass/userModule/auth.scss");
__webpack_require__(/*! C:\OSPanel\domains\bus-lines.lk\resources\assets\sass\userModule\userslist.scss */"./resources/assets/sass/userModule/userslist.scss");
__webpack_require__(/*! C:\OSPanel\domains\bus-lines.lk\resources\assets\sass\userModule\userProfile.scss */"./resources/assets/sass/userModule/userProfile.scss");
__webpack_require__(/*! C:\OSPanel\domains\bus-lines.lk\resources\assets\sass\userModule\settings.scss */"./resources/assets/sass/userModule/settings.scss");
__webpack_require__(/*! C:\OSPanel\domains\bus-lines.lk\resources\assets\sass\userModule\buslist.scss */"./resources/assets/sass/userModule/buslist.scss");
__webpack_require__(/*! C:\OSPanel\domains\bus-lines.lk\resources\assets\sass\userModule\busProfile.scss */"./resources/assets/sass/userModule/busProfile.scss");
__webpack_require__(/*! C:\OSPanel\domains\bus-lines.lk\resources\assets\sass\userModule\finances.scss */"./resources/assets/sass/userModule/finances.scss");
__webpack_require__(/*! C:\OSPanel\domains\bus-lines.lk\resources\assets\sass\userModule\tripsList.scss */"./resources/assets/sass/userModule/tripsList.scss");
__webpack_require__(/*! C:\OSPanel\domains\bus-lines.lk\resources\assets\sass\userModule\tripStore.scss */"./resources/assets/sass/userModule/tripStore.scss");
__webpack_require__(/*! C:\OSPanel\domains\bus-lines.lk\resources\assets\sass\userModule\tripProfile.scss */"./resources/assets/sass/userModule/tripProfile.scss");
module.exports = __webpack_require__(/*! C:\OSPanel\domains\bus-lines.lk\resources\assets\sass\loader.scss */"./resources/assets/sass/loader.scss");
