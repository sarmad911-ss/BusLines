<template>
    <div class="document">
        ...
        <div v-else class="document__full">
            ...
            <span  class="link-text m-8">
                <i class="icon default mail-icon"></i> Отправить на почту
            </span>
            <div class="gray-links m-8">
                <a class="gray-light-text" href="#">
            ...
            <div class="gray-links m-8">
                <div class="gray-light-text" @click="$refs.fileInput.click()">
                    <i class="icon default replace-icon"></i> Заменить
                </div>
                <div class="gray-light-text" @click="deleteFile">
                    <i class="icon default delete-icon"></i> Удалить
                </div>
            </div>
            <div class="gray-light-text last-update-text" v-if="value.last_update">
                <div>Посл. изменение</div>
                <div>
